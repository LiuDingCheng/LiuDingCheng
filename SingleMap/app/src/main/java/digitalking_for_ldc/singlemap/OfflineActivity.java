...
public class OfflineActivity extends Activity implements MKOfflineMapListener {
    ...
    private ArrayList<String> hotCities = new ArrayList<String>();// 要装载热闹城市列表
    ...
    public void remove(View view) {
        ...
        downtxt.setText("下载进度");
        ToastUtil.CreateToastShow(this, null, "温馨提示", "删除离线地图. cityid: " + city_id);
